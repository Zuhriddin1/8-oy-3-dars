...
const Header: FC = () => {
  ...
  const handleSave = () => {
    const RegTodos = localStorage.getItem("todos");
    const EnterTodo: Todo[] = RegTodos ? JSON.parse(RegTodos) : [];
    const newTodo: Todo = { work: todoWork, time: todoTime };
    const updatedTodos = [...EnterTodo, newTodo];
